	...
	var __vue_render__ = function() {
	  ...
	  return _c(
	    ...
	    [
	      _c(
	        "div",
	        { staticClass: "flex-display w-full items-center justify-between" },
	        [
	          _c(
	            "div",
	            {
	              staticClass: "flex-display flex-initial flex-wrap",
	              attrs: { "data-cy": "tags" }
	            },
	            [
	              _c("input", {
	              ...
	              _vm._l(_vm.value, function(tag, index) {
	                return _c(
	                  "span",
	                  { key: index, staticClass: "flex-display items-center" },
	                  [
	          ...
	          _vm._v(" "),
	          _c("div", { staticClass: "flex-display flex-auto justify-end" }, [
	            _c("div", { staticClass: "flex-display items-center" }, [
	              _vm.clearable
	                ? _c(
	                    "div",
	                    {
